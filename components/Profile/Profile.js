    ...
    <div className={styles["profile-container"]}>
      ...
      <section>
        ...
        <div className={styles["profile-experience"]}>
          <p style={spaceGrotesk.style}>March - May 2023</p>
          <div>
        ...
        <div className={styles["profile-experience"]}>
          <p style={spaceGrotesk.style}>2022 - Present</p>
          <div>
        ...
        <div className={styles["profile-experience"]}>
          <p style={spaceGrotesk.style}>February - April 2022</p>
          <div>
        ...
        <div className={styles["profile-experience"]}>
          <p style={spaceGrotesk.style}>August - December 2021</p>
          <div>
